...
<body>
  ...
  <div class="page">
    <div class="page-header">
      ...
      <p>Perbandingan ranking AHP+SAW vs AHP+WP &nbsp;·&nbsp; <?= count($patients) ?> pasien dimuat &nbsp;·&nbsp;
        <?= $pdo ? 'Database: Terhubung' : 'Mode Demo (DB tidak terhubung)' ?>
      </p>
      <?php if ($dbError): ?>
    ...
    <div class="spearman-box">
      <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:2rem;flex-wrap:wrap">
        <div>
          <div
            style="font-size:.75rem;color:var(--muted);letter-spacing:.1em;text-transform:uppercase;margin-bottom:.3rem">
            Korelasi Spearman (SAW vs WP)</div>
        ...
        <div style="display:flex;gap:2rem;flex-wrap:wrap">
          <div>
            <div style="font-size:.72rem;color:var(--muted);text-transform:uppercase;letter-spacing:.08em">Bobot AHP
            </div>
          ...
          <div>
            <div style="font-size:.72rem;color:var(--muted);text-transform:uppercase;letter-spacing:.08em">Konsistensi
              AHP</div>
            <div style="margin-top:.3rem;font-size:.83rem">CR = <strong
                style="color:<?= $ahpDetail['is_consistent'] ? 'var(--green)' : 'var(--accent)' ?>"><?= round($ahpDetail['consistency_ratio'], 4) ?></strong>
            </div>
            <div style="font-size:.78rem;color:var(--muted)">
              <?= $ahpDetail['is_consistent'] ? 'Konsisten (CR < 0.1)' : '⚠ Tidak konsisten' ?>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="stats-row">
      <div class="stat-card">
        <div class="sv sv-red"><?= $sawSummary['by_priority']['KRITIS'] ?? 0 ?></div>
        <div class="sl">Kritis (SAW)</div>
      </div>
      <div class="stat-card">
        <div class="sv sv-orange"><?= $sawSummary['by_priority']['TINGGI'] ?? 0 ?></div>
        <div class="sl">Tinggi (SAW)</div>
      </div>
      <div class="stat-card">
        <div class="sv sv-red"><?= $wpSummary['by_priority']['KRITIS'] ?? 0 ?></div>
        <div class="sl">Kritis (WP)</div>
      </div>
      <div class="stat-card">
        <div class="sv sv-orange"><?= $wpSummary['by_priority']['TINGGI'] ?? 0 ?></div>
        <div class="sl">Tinggi (WP)</div>
      </div>
      <div class="stat-card">
        <div class="sv sv-blue"><?= count($patients) ?></div>
        <div class="sl">Total Pasien</div>
      </div>
    </div>
    ...
    <div class="toolbar">
      <form method="GET" style="display:contents">
        <div class="search-box">
          ...
          <input type="text" name="search" placeholder="Cari patient ID..." value="<?= htmlspecialchars($search) ?>"
